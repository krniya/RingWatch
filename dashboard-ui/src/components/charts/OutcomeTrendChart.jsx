...
export function OutcomeTrendChart({ data, isLoading, periodUnit, rangeLabel }) {
  return (
    <ChartPanel title="Outcome Trend" subtitle={`Decisions per ${periodUnit}, ${rangeLabel}`} isLoading={isLoading}>
      <BarChart data={data}>
