...
export function RingDetectionsChart({ data, isLoading, periodUnit, rangeLabel }) {
  return (
    <ChartPanel title="Fraud Rings Detected" subtitle={`Detections per ${periodUnit}, ${rangeLabel}`} isLoading={isLoading}>
      <BarChart data={data}>
